...
const { readCompanyData, writeCompanyData, logCompanyActivity } = require('../server/utils/company-database');
...
module.exports = async (req, res) => {
    ...
    if (urlPath.endsWith('recording-proxy')) {
        try {
            ...
            const getTwilioCredentials = require('../server/utils/getTwilioCredentials');
