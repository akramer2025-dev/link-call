...
module.exports = async (req, res) => {
    ...
    try {
        ...
        console.log('📞 req.body كامل:', JSON.stringify(req.body));
        ...
        console.log('📞 ═══ Credentials المستخدمة ═══');
        console.log(`📞 accountSid: ${creds.accountSid ? creds.accountSid.substring(0, 10) + '...' : 'NULL'}`);
        console.log(`📞 apiKey: ${creds.apiKey || 'NULL'}`);
        console.log(`📞 twimlAppSid: ${creds.twimlAppSid || 'NULL'}`);
        console.log(`📞 callerPhoneNumber: ${callerPhoneNumber || 'NULL'}`);
        console.log(`📞 default ENV SID: ${process.env.TWILIO_ACCOUNT_SID ? process.env.TWILIO_ACCOUNT_SID.substring(0, 10) + '...' : 'NULL'}`);
        console.log(`📞 default ENV Phone: ${process.env.TWILIO_PHONE_NUMBER || 'NULL'}`);
