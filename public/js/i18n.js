...
const i18n = {
    translations: {
        ar: {
            ...
            nav_accounts: 'الحسابات والرواتب',
            ...
            // Accounts & Payroll page
            acc_title: '💰 الحسابات والرواتب',
            acc_back: '⬅️ لوحة المطور',
            acc_print: '🖨️ طباعة',
            acc_export_csv: '📥 تصدير CSV',
            acc_stat_out: 'إجمالي الصرف',
            acc_stat_in: 'إجمالي القبض',
            acc_stat_balance: 'الرصيد الصافي',
            acc_stat_salaries: 'مجموع الرواتب المصروفة',
            acc_tab_payments: '📤 سندات الصرف',
            acc_tab_receipts: '📥 سندات القبض',
            acc_tab_salaries: '👥 الرواتب',
            acc_tab_reports: '📊 التقارير',
            acc_payments_title: '📤 سندات الصرف',
            acc_receipts_title: '📥 سندات القبض',
            acc_btn_new_payment: '➕ سند صرف جديد',
            acc_btn_new_receipt: '➕ سند قبض جديد',
            acc_col_voucher_id: 'رقم السند',
            acc_col_date: 'التاريخ',
            acc_col_recipient: 'المستلم',
            acc_col_payer: 'من (المُودِع)',
            acc_col_description: 'الوصف',
            acc_col_category: 'التصنيف',
            acc_col_amount: 'المبلغ',
            acc_col_status: 'الحالة',
            acc_col_actions: 'إجراءات',
            acc_salaries_title: '👥 إدارة الرواتب',
            acc_pay_salaries: '💳 صرف رواتب الموظفين',
            acc_salary_history: '📋 سجل الرواتب المصروفة',
            acc_all_months: 'كل الأشهر',
            acc_col_record_id: 'رقم السجل',
            acc_col_employee: 'الموظف',
            acc_col_month: 'الشهر',
            acc_col_base_salary: 'الراتب الأساسي',
            acc_col_bonuses: 'المكافآت',
            acc_col_deductions: 'الخصومات',
            acc_col_net: 'الصافي',
            acc_col_voucher_ref: 'رقم سند الصرف',
            acc_col_pay_date: 'تاريخ الصرف',
            acc_reports_title: '📊 تقارير مفصلة',
            acc_apply_filter: '🔍 تطبيق',
            acc_emp_report_title: '👤 تقرير تفصيلي لكل موظف',
            acc_col_salary_count: 'عدد الرواتب المصروفة',
            acc_col_total_bonuses: 'إجمالي المكافآت',
            acc_col_total_deductions: 'إجمالي الخصومات',
            acc_col_total_net: 'إجمالي الصافي المصروف',
            acc_col_last_pay: 'آخر صرف',
            acc_modal_payment_title: '📤 سند صرف جديد',
            acc_modal_receipt_title: '📥 سند قبض جديد',
            acc_voucher_data: 'بيانات السند',
            acc_label_recipient: 'اسم المستلم / الجهة',
            acc_label_payer: 'اسم المُودِع / الجهة',
            acc_label_amount: 'المبلغ',
            acc_label_currency: 'العملة',
            acc_label_date: 'التاريخ',
            acc_label_recipient_type: 'نوع المستلم',
            acc_label_category: 'التصنيف',
            acc_label_description: 'الوصف / البيان',
            acc_label_notes: 'ملاحظات إضافية',
            acc_btn_create_voucher: '✅ إنشاء السند',
            acc_opt_employee: 'موظف',
            acc_opt_supplier: 'مورد',
            acc_opt_client_refund: 'عميل (استرداد)',
            acc_opt_other: 'أخرى',
            acc_opt_salary: 'راتب',
            acc_opt_bonus: 'مكافأة',
            acc_opt_expense: 'مصروف تشغيلي',
            acc_opt_invoice: 'فاتورة مورد',
            acc_opt_refund: 'استرداد',
            acc_modal_salary_title: '💳 صرف راتب موظف',
            acc_salary_data: 'بيانات الراتب',
            acc_label_employee: 'الموظف',
            acc_label_month: 'الشهر',
            acc_label_base_salary: 'الراتب الأساسي',
            acc_label_bonuses: 'المكافآت والبدلات',
            acc_label_deductions: 'الخصومات',
            acc_label_notes2: 'ملاحظات',
            acc_btn_pay_salary: '💳 صرف الراتب',
            acc_modal_setting_title: '⚙️ إعداد راتب الموظف',
            acc_label_default_salary: 'الراتب الأساسي الافتراضي',
            acc_btn_save_setting: '💾 حفظ الإعداد',
            acc_search_ph: 'بحث...'
        },
        ...
        en: {
            ...
            // Accounts & Payroll page
            acc_title: '💰 Accounts & Payroll',
            acc_back: '⬅️ Developer Panel',
            acc_print: '🖨️ Print',
            acc_export_csv: '📥 Export CSV',
            acc_stat_out: 'Total Payments',
            acc_stat_in: 'Total Receipts',
            acc_stat_balance: 'Net Balance',
            acc_stat_salaries: 'Total Salaries Paid',
            acc_tab_payments: '📤 Payment Vouchers',
            acc_tab_receipts: '📥 Receipt Vouchers',
            acc_tab_salaries: '👥 Salaries',
            acc_tab_reports: '📊 Reports',
            acc_payments_title: '📤 Payment Vouchers',
            acc_receipts_title: '📥 Receipt Vouchers',
            acc_btn_new_payment: '➕ New Payment Voucher',
            acc_btn_new_receipt: '➕ New Receipt Voucher',
            acc_col_voucher_id: 'Voucher No.',
            acc_col_date: 'Date',
            acc_col_recipient: 'Recipient',
            acc_col_payer: 'Payer',
            acc_col_description: 'Description',
            acc_col_category: 'Category',
            acc_col_amount: 'Amount',
            acc_col_status: 'Status',
            acc_col_actions: 'Actions',
            acc_salaries_title: '👥 Salary Management',
            acc_pay_salaries: '💳 Pay Employee Salaries',
            acc_salary_history: '📋 Salary Payment History',
            acc_all_months: 'All Months',
            acc_col_record_id: 'Record No.',
            acc_col_employee: 'Employee',
            acc_col_month: 'Month',
            acc_col_base_salary: 'Base Salary',
            acc_col_bonuses: 'Bonuses',
            acc_col_deductions: 'Deductions',
            acc_col_net: 'Net',
            acc_col_voucher_ref: 'Voucher Ref.',
            acc_col_pay_date: 'Pay Date',
            acc_reports_title: '📊 Detailed Reports',
            acc_apply_filter: '🔍 Apply',
            acc_emp_report_title: '👤 Per-Employee Report',
            acc_col_salary_count: 'Salaries Paid',
            acc_col_total_bonuses: 'Total Bonuses',
            acc_col_total_deductions: 'Total Deductions',
            acc_col_total_net: 'Total Net Paid',
            acc_col_last_pay: 'Last Payment',
            acc_modal_payment_title: '📤 New Payment Voucher',
            acc_modal_receipt_title: '📥 New Receipt Voucher',
            acc_voucher_data: 'Voucher Details',
            acc_label_recipient: 'Recipient Name / Entity',
            acc_label_payer: 'Payer Name / Entity',
            acc_label_amount: 'Amount',
            acc_label_currency: 'Currency',
            acc_label_date: 'Date',
            acc_label_recipient_type: 'Recipient Type',
            acc_label_category: 'Category',
            acc_label_description: 'Description / Narration',
            acc_label_notes: 'Additional Notes',
            acc_btn_create_voucher: '✅ Create Voucher',
            acc_opt_employee: 'Employee',
            acc_opt_supplier: 'Supplier',
            acc_opt_client_refund: 'Client (Refund)',
            acc_opt_other: 'Other',
            acc_opt_salary: 'Salary',
            acc_opt_bonus: 'Bonus',
            acc_opt_expense: 'Operating Expense',
            acc_opt_invoice: 'Supplier Invoice',
            acc_opt_refund: 'Refund',
            acc_modal_salary_title: '💳 Pay Employee Salary',
            acc_salary_data: 'Salary Details',
            acc_label_employee: 'Employee',
            acc_label_month: 'Month',
            acc_label_base_salary: 'Base Salary',
            acc_label_bonuses: 'Bonuses & Allowances',
            acc_label_deductions: 'Deductions',
            acc_label_notes2: 'Notes',
            acc_btn_pay_salary: '💳 Pay Salary',
            acc_modal_setting_title: '⚙️ Employee Salary Settings',
            acc_label_default_salary: 'Default Base Salary',
            acc_btn_save_setting: '💾 Save Settings',
            acc_search_ph: 'Search...'
        }
    },
